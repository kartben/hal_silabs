...
def write_header(path: Path, family, peripherals: dict, abuses: list) -> None:
  ...
  lines = [
    "/**",
    " * @file",
    f" * @brief Pin Control for Silicon Labs {family.upper()} devices",
    " *",
    f" * This file was generated by the script {Path(__file__).name} in the hal_silabs module.",
    " * Do not manually edit.",
    " *",
    f" * @copyright Copyright (c) {datetime.date.today().year} Silicon Laboratories Inc.",
    " * SPDX-License-Identifier: Apache-2.0",
    " */",
    "",
    ...
    "",
    "/**",
    " * @name Generic peripheral signal macros",
    " * @{",
    " */",
  ]
  ...
  lines.append("")
  lines.append("/**")
  lines.append(" * @name Pin-specific macros using peripheral macros")
  lines.append(" * @{")
  lines.append(" */")
  ...
  lines.append("")
  lines.append("/**")
  lines.append(" * @name Analog bus macros")
  lines.append(" * @{")
  lines.append(" */")
